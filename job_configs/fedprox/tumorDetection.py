...
def main(batch_sz, epochs, lr, split_method, fedproxloss_mu):
            ...
            for phase in ['train', 'test']:
                ...
                for features, labels in image_dataloaders[phase]:
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        ...
                        if fedproxloss_mu > 0:
                              fed_prox_loss = criterion_prox(net, model_global)
                              loss += fed_prox_loss
...
if __name__ == "__main__":
    ...
    main(batch_sz=args.batch_sz, epochs=args.epochs, lr=args.lr, split_method=args.split_method, fedproxloss_mu=args.fedproxloss_mu)
